...
function Scene() {
  const bumpMap = useTexture("https://importlio-bucket.nyc3.cdn.digitaloceanspaces.com/assets/bump-maps/bump.jpg");
  const envMap = useCubeTexture(
    ["px.png", "nx.png", "py.png", "ny.png", "pz.png", "nz.png"],
    { path: "https://importlio-bucket.nyc3.cdn.digitaloceanspaces.com/assets/cube/" }
  );
