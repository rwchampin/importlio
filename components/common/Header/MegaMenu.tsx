...
//     id: 1,
//     name: 'Free Lists',
//     description: 'Get access to our free email lists to get started.',
//     icon: <BiDollarCircle className="h-6 w-6 flex-shrink-0 text-gray-400" aria-hidden="true" />,
//     href: '#',
//   },
//   {
//     id: 2,
//     name: 'Niche Email Lists',
//     description: "We categorize all our lists by niche.  Don't see a list you need?  Let us know.",
//     href: '#',
//     icon: <BsStars className="h-6 w-6 flex-shrink-0 text-gray-400" aria-hidden="true" />,
//   },
//   {
//     id: 3,
//     name: 'Custom Marketing Lists',
//     description: 'Create your own custom email lists by keyword(s), location, or niche.',
//     href: '#',
//     icon: <AiOutlineLineChart className="h-6 w-6 flex-shrink-0 text-gray-400" aria-hidden="true" />,
//   },

// ]
 
// export default function MegaMenu({ setOpenMegaMenu, open  }: { open: any }) {
...
//           >
//             <Popover.Panel className="absolute inset-x-0 z-10 mx-auto transform shadow-lg w-full max-w-[90vw] rounded-xl bg-gray-200">
...
//                   </h2>
//                   <div>
//                     <h3 className="text-base font-medium text-black">Email Marketing</h3>
//                     <p className='text-xs text-gray-500'>
//                       Learn how you can instantly market your products and services to millions of people.
//                     </p>
...
//                     </ul>
//                     <Button
//                       className="bg-button text-offwhite mt-3"
//                       size="lg"
//                       fullWidth={true}
//                     >Join Now!</Button>
//                   </div>
...
//                         <li key={post.i} className="flow-root">
//                           <a
//                             href={post.href}
