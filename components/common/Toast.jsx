    ...
    <Toast.Provider swipeDirection="right">
      ...
      >
        ...
        <Toast.Action className="[grid-area:_action]" asChild altText="Goto schedule to undo">
          <button className="inline-flex items-center justify-center rounded font-medium text-xs px-[10px] leading-[25px] h-[25px] bg-gray2 text-gray11 shadow-[inset_0_0_0_1px] shadow-gray7 hover:shadow-[inset_0_0_0_1px] hover:shadow-gray8 focus:shadow-[0_0_0_2px] focus:shadow-gray8">
            Undo
          </button>
        </Toast.Action>
      </Toast.Root>
