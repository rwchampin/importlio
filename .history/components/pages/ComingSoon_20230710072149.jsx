...
export default function ComingSoon() {
    ...
    return (
        ...
        <div className="flex flex-col w-full ">
            <div className="text-center font-bold font-apercu text-gray-500">The #1 AI powered</div>
            <h1 className="font-montserrat text-center text-black font-black text-3xl md:text-3xl">
