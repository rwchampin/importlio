...
export default function ComingSoon() {
    ...
    return (
        ...
        <div className="flex flex-col w-full ">
            ...
            <h1 className="font-montserrat text-center text-black font-black text-3xl">
          Amazon Dropshipping Product Import App
        </h1>
        <h2 className='font-apercu-bold text-center text-md font-bold text-slate-400'>Import UNLIMITED amazon products into Shopify in minutes</h2>
