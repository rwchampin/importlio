...
const Title = ({ children, className, ...rest }) => {
    ...
    return (
        <h1 style={{ perspective: 800, transformStyle: 'preserve-3d', filter: 'drop-shadow(3px 3px 4px black', color: 'white'}} ref={titleRef} className={`${className} shadow-lg text-5xl font-montserrat font-black`} {...rest}>
            {children}
        </h1>
    );
};
