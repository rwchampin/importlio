      ...
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="bg-green-500 relative flex h-16 items-center justify-between w-full">
              ...
              {/* <div className="w-full flex flex-1 items-center md:justify-between sm:items-stretch sm:justify-start"> */}
                <div className="bg-red-500 flex justify-between items-center w-full">
