...
export default function ComingSoon() {
    ...
    return (
        ...
        <h2 className='font-apercu-bold text-center text-md font-bold text-black'>
            ...
            <div className="text-center text-lg font-apercu text-gray-400">Pre-register today for a chance to be one of the first 1000 customers to get a free membership</div>
