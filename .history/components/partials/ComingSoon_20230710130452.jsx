...
export default function ComingSoon() {
    ...
    return (
        ...
        <h2 className='font-apercu-bold text-center text-md font-bold text-black'>
            ...
            <div className="text-center text-2xl max-w-lg font-apercu text-black">Pre-register today for a chance to be one of the first 1000 customers to get a free membership</div>
