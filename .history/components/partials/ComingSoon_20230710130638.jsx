...
export default function ComingSoon() {
    ...
    return (
        ...
        <h2 className='font-apercu-bold text-center text-md font-bold text-black'>
            ...
            <div className="text-center text-xl max-w-2xl font-apercu font-black text-black">Pre-register today for a chance to be one of the first 1000 customers to get a free membership</div>
