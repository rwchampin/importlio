           ...
           <Tab.Panel
            ...
            <form>
              <div class="flex flex-col gap-5 mb-4">
                <input class="border py-2 px-3 text-grey-800" type="text" name="name" id="name" placeholder="Name" />
                <button class="bg-black text-white mx-auto rounded-lg" type="submit">Submit</button>
              </div>
            </form>
            </Tab.Panel>
           <Tab.Panel
